# EU4 Local Reference Index (Implementation Support)

This index helps locate local EU4 wiki snapshots relevant to Anbennar scripting work.

It is not a replacement for repo-grounded scanning.

## Core scripting references

- `eu4-wiki/Modding - Europa Universalis 4 Wiki.html`
