...
- `_templates/`:
  - reusable plan/checklist/dossier templates
- `verne/`:
...
3. Fill `country-dossier.md` from template (canon class + gameplay intent + lore role + dependencies + behavior deltas).
4. Fill `checklist-status-manifest.json` flags (`scanned/mapped/verified`).
5. Add repo-maps/checklists as needed.
6. Run automation checks before implementation.
