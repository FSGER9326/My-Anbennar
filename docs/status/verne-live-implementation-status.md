...
Last reviewed from code: **2026-03-31**
...
| Mission rewrite / mission integration | **Partial** | `missions/Verne_Missions.txt`, `common/scripted_triggers/verne_overhaul_triggers.txt`, `common/scripted_effects/verne_overhaul_effects.txt`, `localisation/verne_overhaul_l_english.yml` | The live Verne mission tree already carries many helper-layer integrations, variables, flags, and state hooks. However, this remains the highest-risk playability surface and needs a dedicated audit against the newer doctrine/reform/dynasty/state systems. |
...
| Localisation coverage | **Partial** | `localisation/verne_overhaul_l_english.yml`, `localisation/verne_overhaul_dynasty_l_english.yml` | Coverage is broad for the systems audited here, including doctrines, reforms, decisions, advisors, modifiers, and crisis content. But localisation coverage should still be treated as an ongoing verification task whenever gameplay owner files change. |
