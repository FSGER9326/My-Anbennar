...
| Overhaul policies | `common/policies/verne_doctrine_policies.txt` | Canonical | Add doctrine policy objects here. | Dedicated policy ownership file for doctrine expansion. |
...
| Overhaul decisions | `decisions/verne_overhaul_decisions.txt` | Canonical | Primary overhaul decision file. | Decision anchor for dynasty/court overhaul milestones. |
