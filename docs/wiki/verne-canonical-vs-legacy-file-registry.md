...
| Overhaul doctrine content | `common/ideas/verne_doctrine_groups.txt` | Canonical | Add/modify doctrine groups here. | Primary overhaul doctrine object file. **Maturity:** partial implementation at present (single live group: `verne_doctrine_silver_wake`). |
...
| Overhaul reforms | `common/government_reforms/verne_overhaul_reforms.txt` | Canonical | Add/modify overhaul reforms here. | Dedicated reform ownership layer. **Maturity:** partial implementation at present (tier-1 triplet live; higher-tier package pending). |
...
| Overhaul localization (general) | `localisation/verne_overhaul_l_english.yml` | Canonical | Add non-scaffold overhaul localization here. | Primary localization namespace for reusable systems. **Maturity:** mixed (live doctrine/reform/helper keys plus in-progress tooltip namespace normalization). |
