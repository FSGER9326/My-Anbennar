...
- python scripts/checklist_manifest_audit.py --manifest $base/checklist-status-manifest.json --index-file docs/repo-maps/README.md --index-file docs/repo-maps/anbennar-systems-master-index.md --index-file docs/repo-maps/anbennar-systems-scan-roadmap.md
EOT
